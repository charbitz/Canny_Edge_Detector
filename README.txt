The purpose of this project was the implementation of Canny's Edge detector. 
...
- Images  : the folder with the testing images
- results : the folder with some screenshot results for every testing image.